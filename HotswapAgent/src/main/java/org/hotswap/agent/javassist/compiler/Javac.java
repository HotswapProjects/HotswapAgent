...
public class Javac {
    ...
    public static class CtFieldWithInit extends CtField {
        ...
        CtFieldWithInit(org.hotswap.agent.javassist.CtClass type, String name, org.hotswap.agent.javassist.CtClass declaring)
     ...
     */
    public int recordParams(String target, org.hotswap.agent.javassist.CtClass[] params,
     ...
     */
    public int recordReturnType(org.hotswap.agent.javassist.CtClass type, boolean useResultVar)
            throws CompileError {
        gen.recordType(type);
     ...
     */
    public int recordVariable(org.hotswap.agent.javassist.CtClass type, String name)
            throws CompileError {
    ...
    public void recordProceed(String target, String method)
        ...
        org.hotswap.agent.javassist.compiler.ProceedHandler h = new org.hotswap.agent.javassist.compiler.ProceedHandler() {
            public void doit(org.hotswap.agent.javassist.compiler.JvstCodeGen gen, Bytecode b, org.hotswap.agent.javassist.compiler.ast.ASTList args)
                    throws CompileError {
                org.hotswap.agent.javassist.compiler.ast.ASTree expr = new org.hotswap.agent.javassist.compiler.ast.Member(m);
                if (texpr != null)
    ...
    public void recordStaticProceed(String targetClass, String method)
        ...
        org.hotswap.agent.javassist.compiler.ProceedHandler h = new org.hotswap.agent.javassist.compiler.ProceedHandler() {
            public void doit(org.hotswap.agent.javassist.compiler.JvstCodeGen gen, Bytecode b, org.hotswap.agent.javassist.compiler.ast.ASTList args)
                    throws CompileError {
                org.hotswap.agent.javassist.compiler.ast.Expr expr = org.hotswap.agent.javassist.compiler.ast.Expr.make(org.hotswap.agent.javassist.compiler.TokenId.MEMBER,
                        new org.hotswap.agent.javassist.compiler.ast.Symbol(c), new org.hotswap.agent.javassist.compiler.ast.Member(m));
                expr = org.hotswap.agent.javassist.compiler.ast.CallExpr.makeCall(expr, args);
                gen.compileExpr(expr);
                gen.addNullIfVoid();
            }
