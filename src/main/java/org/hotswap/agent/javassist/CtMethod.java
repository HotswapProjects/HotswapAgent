...
public final class CtMethod extends CtBehavior {
    ...
    /**
     * @see #make(org.hotswap.agent.javassist.bytecode.MethodInfo minfo, CtClass declaring)
     */
    CtMethod(org.hotswap.agent.javassist.bytecode.MethodInfo minfo, CtClass declaring) {
    ...
    public CtMethod(CtClass returnType, String mname,
        ...
        String desc = org.hotswap.agent.javassist.bytecode.Descriptor.ofMethod(returnType, parameters);
        methodInfo = new org.hotswap.agent.javassist.bytecode.MethodInfo(cp, mname, desc);
        setModifiers(org.hotswap.agent.javassist.Modifier.PUBLIC | org.hotswap.agent.javassist.Modifier.ABSTRACT);
    }
     ...
     * @since 3.6
     */
    public static CtMethod make(org.hotswap.agent.javassist.bytecode.MethodInfo minfo, CtClass declaring)
            throws CannotCompileException {
    ...
    final String getStringRep() {
        if (cachedStringRep == null)
            cachedStringRep = methodInfo.getName()
                    + org.hotswap.agent.javassist.bytecode.Descriptor.getParamDescriptor(methodInfo.getDescriptor());
     ...
     * such as <code>CtMethod.setBody(String)</code>.
     *
     * @since 3.5
     */
    public String getLongName() {
        return getDeclaringClass().getName() + "."
                + getName() + org.hotswap.agent.javassist.bytecode.Descriptor.toString(getSignature());
    }
    ...
    public boolean isEmpty() {
        ...
        if (ca == null)         // abstract or native
            return (getModifiers() & org.hotswap.agent.javassist.Modifier.ABSTRACT) != 0;

        org.hotswap.agent.javassist.bytecode.CodeIterator it = ca.iterator();
        try {
            return it.hasNext() && it.byteAt(it.next()) == org.hotswap.agent.javassist.bytecode.Opcode.RETURN
                    && !it.hasNext();
    ...
    public void setWrappedBody(CtMethod mbody, ConstParameter constParam)
        ...
        org.hotswap.agent.javassist.bytecode.Bytecode code = CtNewWrappedMethod.makeBody(clazz,
                clazz.getClassFile2(),
                mbody,
                params, retType,
                constParam);
        org.hotswap.agent.javassist.bytecode.CodeAttribute cattr = code.toCodeAttribute();
    ...
    public static class ConstParameter {
         ...
         */
        int compile(org.hotswap.agent.javassist.bytecode.Bytecode code) throws CannotCompileException {
            return 0;
        }
