...
public class MethodInfo {
    org.hotswap.agent.javassist.bytecode.ConstPool constPool;
    int accessFlags;
    int name;
    String cachedName;
    int descriptor;
    ...
    private MethodInfo(org.hotswap.agent.javassist.bytecode.ConstPool cp) {
        constPool = cp;
        attribute = null;
    }
     ...
     * @see Descriptor
     */
    public MethodInfo(org.hotswap.agent.javassist.bytecode.ConstPool cp, String methodname, String desc) {
        this(cp);
        accessFlags = 0;
    ...
    MethodInfo(org.hotswap.agent.javassist.bytecode.ConstPool cp, DataInputStream in) throws IOException {
        this(cp);
        read(in);
    }
     ...
     * @param classnameMap specifies pairs of replaced and substituted name.
     * @see Descriptor
     */
    public MethodInfo(org.hotswap.agent.javassist.bytecode.ConstPool cp, String methodname, MethodInfo src,
     ...
     */
    void compact(org.hotswap.agent.javassist.bytecode.ConstPool cp) {
    ...
    void prune(org.hotswap.agent.javassist.bytecode.ConstPool cp) {
        ...
        org.hotswap.agent.javassist.bytecode.AnnotationDefaultAttribute defaultAttribute
                = (org.hotswap.agent.javassist.bytecode.AnnotationDefaultAttribute) getAttribute(org.hotswap.agent.javassist.bytecode.AnnotationDefaultAttribute.tag);
        if (defaultAttribute != null)
            newAttributes.add(defaultAttribute);

        org.hotswap.agent.javassist.bytecode.ExceptionsAttribute ea = getExceptionsAttribute();
        if (ea != null)
            newAttributes.add(ea);

        AttributeInfo signature
                = getAttribute(org.hotswap.agent.javassist.bytecode.SignatureAttribute.tag);
        if (signature != null) {
     ...
     */
    public org.hotswap.agent.javassist.bytecode.ExceptionsAttribute getExceptionsAttribute() {
        AttributeInfo info = AttributeInfo.lookup(attribute,
                org.hotswap.agent.javassist.bytecode.ExceptionsAttribute.tag);
        return (org.hotswap.agent.javassist.bytecode.ExceptionsAttribute) info;
    }
    ...
    public void removeExceptionsAttribute() {
        AttributeInfo.remove(attribute, org.hotswap.agent.javassist.bytecode.ExceptionsAttribute.tag);
    }
     ...
     * <code>method_info</code> structure.
     */
    public void setExceptionsAttribute(org.hotswap.agent.javassist.bytecode.ExceptionsAttribute cattr) {
     ...
     * @see #rebuildStackMap(org.hotswap.agent.javassist.ClassPool)
     * @see #rebuildStackMapForME(org.hotswap.agent.javassist.ClassPool)
     * @see #doPreverify
     * @since 3.6
     */
    public void rebuildStackMapIf6(org.hotswap.agent.javassist.ClassPool pool, org.hotswap.agent.javassist.bytecode.ClassFile cf)
            throws BadBytecode {
        if (cf.getMajorVersion() >= org.hotswap.agent.javassist.bytecode.ClassFile.JAVA_6)
     ...
     *
     * @param pool used for making type hierarchy.
     * @see org.hotswap.agent.javassist.bytecode.StackMapTable
     * @since 3.6
     */
    public void rebuildStackMap(org.hotswap.agent.javassist.ClassPool pool) throws BadBytecode {
        CodeAttribute ca = getCodeAttribute();
        if (ca != null) {
            org.hotswap.agent.javassist.bytecode.StackMapTable smt = MapMaker.make(pool, this);
            ca.setAttribute(smt);
        }
    }
     ...
     *
     * @param pool used for making type hierarchy.
     * @see org.hotswap.agent.javassist.bytecode.StackMap
     * @since 3.12
     */
    public void rebuildStackMapForME(org.hotswap.agent.javassist.ClassPool pool) throws BadBytecode {
        CodeAttribute ca = getCodeAttribute();
        if (ca != null) {
            org.hotswap.agent.javassist.bytecode.StackMap sm = MapMaker.make2(pool, this);
            ca.setAttribute(sm);
        }
    }
     ...
     *
     * @param pos the position of the bytecode (&gt;= 0). an index into the code
     *            array.
    ...
    public int getLineNumber(int pos) {
        ...
        org.hotswap.agent.javassist.bytecode.LineNumberAttribute ainfo = (org.hotswap.agent.javassist.bytecode.LineNumberAttribute) ca
                .getAttribute(org.hotswap.agent.javassist.bytecode.LineNumberAttribute.tag);
        if (ainfo == null)
            return -1;
    ...
    public void setSuperclass(String superclass) throws BadBytecode {
        ...
        if (pos >= 0) { // not this()
            org.hotswap.agent.javassist.bytecode.ConstPool cp = constPool;
            int mref = org.hotswap.agent.javassist.bytecode.ByteArray.readU16bit(code, pos + 1);
            int nt = cp.getMethodrefNameAndType(mref);
            int sc = cp.addClassInfo(superclass);
            int mref2 = cp.addMethodrefInfo(sc, nt);
            org.hotswap.agent.javassist.bytecode.ByteArray.write16bit(mref2, code, pos + 1);
        }
    }

    private void read(MethodInfo src, String methodname, Map classnames)
            throws BadBytecode {
        org.hotswap.agent.javassist.bytecode.ConstPool destCp = constPool;
        accessFlags = src.accessFlags;
        name = destCp.addUtf8Info(methodname);
        cachedName = methodname;
        org.hotswap.agent.javassist.bytecode.ConstPool srcCp = src.constPool;
        String desc = srcCp.getUtf8Info(src.descriptor);
        String desc2 = Descriptor.rename(desc, classnames);
        descriptor = destCp.addUtf8Info(desc2);

        attribute = new ArrayList();
        org.hotswap.agent.javassist.bytecode.ExceptionsAttribute eattr = src.getExceptionsAttribute();
        if (eattr != null)
