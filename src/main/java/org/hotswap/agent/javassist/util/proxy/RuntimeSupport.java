 ...
 *
 * @see org.hotswap.agent.javassist.util.proxy.ProxyFactory
 */
public class RuntimeSupport {
     ...
     * @since 3.4
     */
    public static org.hotswap.agent.javassist.util.proxy.SerializedProxy makeSerializedProxy(Object proxy)
        ...
        else if (proxy instanceof org.hotswap.agent.javassist.util.proxy.Proxy)
            methodHandler = org.hotswap.agent.javassist.util.proxy.ProxyFactory.getHandler((org.hotswap.agent.javassist.util.proxy.Proxy) proxy);

        return new org.hotswap.agent.javassist.util.proxy.SerializedProxy(clazz, org.hotswap.agent.javassist.util.proxy.ProxyFactory.getFilterSignature(clazz), methodHandler);
    }
}
