 ...
 * <p/>
 * We cannot use java.util.logging because many frameworks and APP servers will complicate/override settings.
 *
 * @author Jiri Bubnik
 */
public class AgentLogger {
    ...
    static {
        setLevel("org.hotswap.agent.plugin", Level.TRACE);
    }
