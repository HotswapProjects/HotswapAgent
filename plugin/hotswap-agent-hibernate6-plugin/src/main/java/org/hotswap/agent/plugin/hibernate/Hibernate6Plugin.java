...
@Plugin(name = "Hibernate6",
        ...
        testedVersions = {"6.1.15.Final"},
        expectedVersions = {"6.1.15"},
        supportClass = {HibernateTransformers.class})
@Versions(
        maven = {
            @Maven(value = "[6.0,7.0)", artifactId = "hibernate-core", groupId = "org.hibernate.orm"),
        },
        manifest= {
                @Manifest(value="[6.0,7.0)", names= {
                ...
                @Manifest(value="[6.0,7.0)", names= {
                        ...
                        @Name(key=Name.ImplementationVendorId, value="org.hibernate.orm")
                }),
        }
        )
public class Hibernate6Plugin {
    private static final String ENTITY_ANNOTATION = "jakarta.persistence.Entity";
    private static AgentLogger LOGGER = AgentLogger.getLogger(Hibernate6Plugin.class);
