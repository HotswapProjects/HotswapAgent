...
`org.hibernate.cfg.Configuration` (for plain Hibernate) to wrap `jakarta.persistence.EntityManagerFactory` or
...
`@jakarta.persistence.Entity` annotation, whole Hibernate configuration is reloaded and target factory is
