 ...
 */
public class RepoMetadataHandlerRefreshAgent {

    private static AgentLogger LOGGER = AgentLogger.getLogger(RepoMetadataHandlerRefreshAgent.class);
     ...
     */
    public static void refreshHandler(ClassLoader appClassLoader, String repoClassName) {
        ...
        try {
            ...
            if (handler != null) {
            	ReflectionHelper.invoke(handler, handler.getClass(), RepositoryMetadataHandlerTransformer.REINITIALIZE_METHOD, new Class[] { Class.class }, repoClass);
