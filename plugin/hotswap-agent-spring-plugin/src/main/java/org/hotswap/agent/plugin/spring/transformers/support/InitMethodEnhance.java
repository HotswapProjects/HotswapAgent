...
public class InitMethodEnhance {
    ...
    public static String catchException(String objectName, String loggerName, String exceptionName, String from,
        ...
        return "{"
            ...
            + " throw " + exceptionName + " ; }"
            + "else {"
            + loggerName + ".warning(\"Failed to invoke init method of {} from {}: {}\", new java.lang.Object[]{"
            + objectName + ".getClass().getName(),\""
            + from + "\", " + exceptionName + ".getMessage()"
            + "});"
            + loggerName + ".debug(\"the detail reason as following{}: \", " + exceptionName + ", new java.lang.Object[]{ "
            + "\" \"});"
