...
public class CtNewConstructor {
    ...
    public static CtConstructor make(String src, CtClass declaring)
        ...
        throw new org.hotswap.agent.javassist.CannotCompileException("not a constructor");
    }
     ...
     * {@link CtConstructor#CtConstructor(CtConstructor, CtClass, org.hotswap.agent.javassist.ClassMap) this constructor}.
     ...
     * @see CtConstructor#CtConstructor(CtConstructor, CtClass, org.hotswap.agent.javassist.ClassMap)
     */
     ...
     * @param declaring  the class to which the created constructor
     *                   is added.
     * @see CtNewMethod#wrapped(CtClass, String, CtClass[], CtClass[], org.hotswap.agent.javassist.CtMethod, org.hotswap.agent.javassist.CtMethod.ConstParameter, CtClass)
     */
    public static CtConstructor make(CtClass[] parameters,
                                     CtClass[] exceptions, int howto,
                                     org.hotswap.agent.javassist.CtMethod body, ConstParameter cparam,
                                     CtClass declaring)
            throws org.hotswap.agent.javassist.CannotCompileException {
        return org.hotswap.agent.javassist.CtNewWrappedConstructor.wrapped(parameters, exceptions,
