...
public class SignatureTest {
    ...
    public void testInterfaceSignature() throws Exception {
        ...
        ClassSignatureValue expected = ClassfileSignatureComparerHelper.getJavaClassSignature(TestSignatures.class, SIGNATURE_ELEMENTS);
        ClassSignatureValue actual = ClassfileSignatureComparerHelper.getCtClassSignature(makeClass, SIGNATURE_ELEMENTS);
    ...
    public void testClassSignature() throws Exception {
        {
            ...
            ClassSignatureValue expected = ClassfileSignatureComparerHelper.getJavaClassSignature(A.class, SIGNATURE_ELEMENTS);
            ClassSignatureValue actual = ClassfileSignatureComparerHelper.getCtClassSignature(makeClass, SIGNATURE_ELEMENTS);
            assertEquals("Signatures not equal", expected, actual);
        }
        {
            CtClass makeClass = ClassPool.getDefault().get(C.class.getName());
            ClassSignatureValue expected = ClassfileSignatureComparerHelper.getJavaClassSignature(C.class, SIGNATURE_ELEMENTS);
            ClassSignatureValue actual = ClassfileSignatureComparerHelper.getCtClassSignature(makeClass, SIGNATURE_ELEMENTS);
            assertEquals("Signatures not equal", expected, actual);
        }
    }
    ...
    public void testAbstractClassSignature() throws Exception {
        ...
        ClassSignatureValue expected = ClassfileSignatureComparerHelper.getJavaClassSignature(B.class, SIGNATURE_ELEMENTS);
        ClassSignatureValue actual = ClassfileSignatureComparerHelper.getCtClassSignature(makeClass, SIGNATURE_ELEMENTS);
        assertEquals("Signatures not equal", expected, actual);
    }
    ...
    public void testOne() throws Exception {
        ...
        ClassSignatureValue expected = ClassfileSignatureComparerHelper.getJavaClassSignature(OneMethod.class, SIGNATURE_ELEMENTS);
        ClassSignatureValue actual = ClassfileSignatureComparerHelper.getCtClassSignature(makeClass, SIGNATURE_ELEMENTS);
        assertEquals("Signatures not equal", expected, actual);
    }
}