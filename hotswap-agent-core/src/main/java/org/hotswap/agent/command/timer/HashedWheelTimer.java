 ...
 * under the License.
 */
package org.hotswap.agent.command.timer;
 ...
 *
 * Some implements refer to apache dubbo
 */
public class HashedWheelTimer implements Timer {
    ...
    private static final AgentLogger logger = AgentLogger.getLogger(HashedWheelTimer.class);
    ...
    private static void reportTooManyInstances() {
        logger.error("You are creating too many instances. " +
                HashedWheelTimer.class.getName() + " is a shared resource that must be reused across the JVM, " +
            ...
            for (; ; ) {
                ...
                try {
                    ...
                    if (logger.isWarnEnabled()) {
                        logger.warning("An exception was thrown while process a cancellation task", t);
                    }
                }
            }
        }
    ...
    private static final class HashedWheelTimeout implements Timeout {
        ...
        public void expire() {
            ...
            try {
                ...
                if (logger.isWarnEnabled()) {
                    logger.warning("An exception was thrown by " + TimerTask.class.getSimpleName() + '.', t);
                }
            }
        }
