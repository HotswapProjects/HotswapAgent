...
import org.hotswap.agent.util.spring.collections.ConcurrentReferenceHashMap;
...
public abstract class ReflectionUtils {
     ...
     */
    public static <T> T invokeJdbcMethod(Method method, Object target) throws SQLException {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T invokeJdbcMethod(Method method, Object target, Object... args) throws SQLException {
        try {
            return (T) method.invoke(target, args);
        } catch (IllegalAccessException ex) {
            handleReflectionException(ex);
