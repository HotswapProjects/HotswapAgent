...
public class ProxyFactory {
    ...
    private void createClass3(ClassLoader cl) {
        ...
        try {
            org.hotswap.agent.javassist.bytecode.ClassFile cf = make();
            if (writeDirectory != null)
                org.hotswap.agent.javassist.util.proxy.FactoryHelper.writeFile(cf, writeDirectory);

            thisClass = org.hotswap.agent.javassist.util.proxy.FactoryHelper.toClass(cf, cl, getDomain());
    ...
    private org.hotswap.agent.javassist.bytecode.ClassFile make() throws CannotCompileException {
        org.hotswap.agent.javassist.bytecode.ClassFile cf = new org.hotswap.agent.javassist.bytecode.ClassFile(false, classname, superName);
        cf.setAccessFlags(org.hotswap.agent.javassist.bytecode.AccessFlag.PUBLIC);
        setInterfaces(cf, interfaces, hasGetHandler ? Proxy.class : org.hotswap.agent.javassist.util.proxy.ProxyObject.class);
        org.hotswap.agent.javassist.bytecode.ConstPool pool = cf.getConstPool();

        // legacy: we only add the static field for the default interceptor if caching is disabled
        if (!factoryUseCache) {
            org.hotswap.agent.javassist.bytecode.FieldInfo finfo = new org.hotswap.agent.javassist.bytecode.FieldInfo(pool, DEFAULT_INTERCEPTOR, HANDLER_TYPE);
            finfo.setAccessFlags(org.hotswap.agent.javassist.bytecode.AccessFlag.PUBLIC | org.hotswap.agent.javassist.bytecode.AccessFlag.STATIC);
            cf.addField(finfo);
        }

        // handler is per instance
        org.hotswap.agent.javassist.bytecode.FieldInfo finfo2 = new org.hotswap.agent.javassist.bytecode.FieldInfo(pool, HANDLER, HANDLER_TYPE);
        finfo2.setAccessFlags(org.hotswap.agent.javassist.bytecode.AccessFlag.PRIVATE);
        cf.addField(finfo2);

        // filter signature is per class
        org.hotswap.agent.javassist.bytecode.FieldInfo finfo3 = new org.hotswap.agent.javassist.bytecode.FieldInfo(pool, FILTER_SIGNATURE_FIELD, FILTER_SIGNATURE_TYPE);
        finfo3.setAccessFlags(org.hotswap.agent.javassist.bytecode.AccessFlag.PUBLIC | org.hotswap.agent.javassist.bytecode.AccessFlag.STATIC);
        cf.addField(finfo3);

        // the proxy class serial uid must always be a fixed value
        org.hotswap.agent.javassist.bytecode.FieldInfo finfo4 = new org.hotswap.agent.javassist.bytecode.FieldInfo(pool, SERIAL_VERSION_UID_FIELD, SERIAL_VERSION_UID_TYPE);
        finfo4.setAccessFlags(org.hotswap.agent.javassist.bytecode.AccessFlag.PUBLIC | org.hotswap.agent.javassist.bytecode.AccessFlag.STATIC | org.hotswap.agent.javassist.bytecode.AccessFlag.FINAL);
        cf.addField(finfo4);
        ...
        if (factoryWriteReplace) {
            ...
            } catch (org.hotswap.agent.javassist.bytecode.DuplicateMemberException e) {
    ...
    private static void setInterfaces(org.hotswap.agent.javassist.bytecode.ClassFile cf, Class[] interfaces, Class proxyClass) {
    ...
    private static void addClassInitializer(org.hotswap.agent.javassist.bytecode.ClassFile cf, org.hotswap.agent.javassist.bytecode.ConstPool cp,
                                            String classname, int size, ArrayList forwarders)
            throws CannotCompileException {
        org.hotswap.agent.javassist.bytecode.FieldInfo finfo = new org.hotswap.agent.javassist.bytecode.FieldInfo(cp, HOLDER, HOLDER_TYPE);
        finfo.setAccessFlags(org.hotswap.agent.javassist.bytecode.AccessFlag.PRIVATE | org.hotswap.agent.javassist.bytecode.AccessFlag.STATIC);
        cf.addField(finfo);
        org.hotswap.agent.javassist.bytecode.MethodInfo minfo = new org.hotswap.agent.javassist.bytecode.MethodInfo(cp, "<clinit>", "()V");
        ...
        org.hotswap.agent.javassist.bytecode.Bytecode code = new org.hotswap.agent.javassist.bytecode.Bytecode(cp, 0, 2);
        ...
        code.addOpcode(org.hotswap.agent.javassist.bytecode.Bytecode.RETURN);
     ...
     */
    private static void callFind2Methods(org.hotswap.agent.javassist.bytecode.Bytecode code, String superMethod, String thisMethod,
    ...
    private static void addSetter(String classname, org.hotswap.agent.javassist.bytecode.ClassFile cf, org.hotswap.agent.javassist.bytecode.ConstPool cp)
            throws CannotCompileException {
        org.hotswap.agent.javassist.bytecode.MethodInfo minfo = new org.hotswap.agent.javassist.bytecode.MethodInfo(cp, HANDLER_SETTER,
                HANDLER_SETTER_TYPE);
        minfo.setAccessFlags(org.hotswap.agent.javassist.bytecode.AccessFlag.PUBLIC);
        org.hotswap.agent.javassist.bytecode.Bytecode code = new org.hotswap.agent.javassist.bytecode.Bytecode(cp, 2, 2);
        code.addAload(0);
        code.addAload(1);
    ...
    private static void addGetter(String classname, org.hotswap.agent.javassist.bytecode.ClassFile cf, org.hotswap.agent.javassist.bytecode.ConstPool cp)
            throws CannotCompileException {
        org.hotswap.agent.javassist.bytecode.MethodInfo minfo = new org.hotswap.agent.javassist.bytecode.MethodInfo(cp, HANDLER_GETTER,
                HANDLER_GETTER_TYPE);
        minfo.setAccessFlags(org.hotswap.agent.javassist.bytecode.AccessFlag.PUBLIC);
        org.hotswap.agent.javassist.bytecode.Bytecode code = new org.hotswap.agent.javassist.bytecode.Bytecode(cp, 1, 1);
        code.addAload(0);
    ...
    private int overrideMethods(org.hotswap.agent.javassist.bytecode.ClassFile cf, org.hotswap.agent.javassist.bytecode.ConstPool cp, String className, ArrayList forwarders)
            throws CannotCompileException {
        ...
        while (it.hasNext()) {
            ...
            if (org.hotswap.agent.javassist.bytecode.ClassFile.MAJOR_VERSION < org.hotswap.agent.javassist.bytecode.ClassFile.JAVA_5 || !isBridge(meth))
    ...
    private void override(String thisClassname, Method meth, String prefix,
                          int index, String desc, org.hotswap.agent.javassist.bytecode.ClassFile cf, org.hotswap.agent.javassist.bytecode.ConstPool cp, ArrayList forwarders)
            throws CannotCompileException {
        ...
        if (Modifier.isAbstract(meth.getModifiers()))
            ...
            org.hotswap.agent.javassist.bytecode.MethodInfo delegator
                    = makeDelegator(meth, desc, cp, declClass, delegatorName);
            // delegator is not a bridge method.  See Sec. 15.12.4.5 of JLS 3rd Ed.
            delegator.setAccessFlags(delegator.getAccessFlags() & ~org.hotswap.agent.javassist.bytecode.AccessFlag.BRIDGE);
            cf.addMethod(delegator);
        }

        org.hotswap.agent.javassist.bytecode.MethodInfo forwarder
                = makeForwarder(thisClassname, meth, desc, cp, declClass,
                delegatorName, index, forwarders);
        cf.addMethod(forwarder);
    }

    private void makeConstructors(String thisClassName, org.hotswap.agent.javassist.bytecode.ClassFile cf,
                                  org.hotswap.agent.javassist.bytecode.ConstPool cp, String classname) throws CannotCompileException {
        ...
        for (int i = 0; i < cons.length; i++) {
            ...
            if (!Modifier.isFinal(mod) && !Modifier.isPrivate(mod)
                ...
                org.hotswap.agent.javassist.bytecode.MethodInfo m = makeConstructor(thisClassName, c, cp, superClass, doHandlerInit);
                cf.addMethod(m);
            }
        }
    }
    ...
    private static org.hotswap.agent.javassist.bytecode.MethodInfo makeConstructor(String thisClassName, Constructor cons,
                                                                                   org.hotswap.agent.javassist.bytecode.ConstPool cp, Class superClass, boolean doHandlerInit) {
        String desc = RuntimeSupport.makeDescriptor(cons.getParameterTypes(),
                Void.TYPE);
        org.hotswap.agent.javassist.bytecode.MethodInfo minfo = new org.hotswap.agent.javassist.bytecode.MethodInfo(cp, "<init>", desc);
        ...
        if (doHandlerInit) {
            ...
            code.addGetstatic(thisClassName, DEFAULT_INTERCEPTOR, HANDLER_TYPE);
            code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.IFNONNULL);
            code.addIndex(10);
        }
        ...
        org.hotswap.agent.javassist.bytecode.CodeAttribute ca = code.toCodeAttribute();
    ...
    private static org.hotswap.agent.javassist.bytecode.MethodInfo makeDelegator(Method meth, String desc,
                                                                                 org.hotswap.agent.javassist.bytecode.ConstPool cp, Class declClass, String delegatorName) {
        org.hotswap.agent.javassist.bytecode.MethodInfo delegator = new org.hotswap.agent.javassist.bytecode.MethodInfo(cp, delegatorName, desc);
     ...
     */
    private static org.hotswap.agent.javassist.bytecode.MethodInfo makeForwarder(String thisClassName,
                                                                                 Method meth, String desc, org.hotswap.agent.javassist.bytecode.ConstPool cp,
                                                                                 Class declClass, String delegatorName, int index,
                                                                                 ArrayList forwarders) {
        org.hotswap.agent.javassist.bytecode.MethodInfo forwarder = new org.hotswap.agent.javassist.bytecode.MethodInfo(cp, meth.getName(), desc);
        forwarder.setAccessFlags(Modifier.FINAL
                | (meth.getModifiers() & ~(Modifier.ABSTRACT
                | Modifier.NATIVE
                | Modifier.SYNCHRONIZED)));
        setThrows(forwarder, cp, meth);
        int args = org.hotswap.agent.javassist.bytecode.Descriptor.paramSize(desc);
        org.hotswap.agent.javassist.bytecode.Bytecode code = new org.hotswap.agent.javassist.bytecode.Bytecode(cp, 0, args + 2);
        /*
         * static {
         *   methods[index * 2]
        ...
        code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.AALOAD);
    ...
    private static void setThrows(org.hotswap.agent.javassist.bytecode.MethodInfo minfo, org.hotswap.agent.javassist.bytecode.ConstPool cp, Method orig) {
        Class[] exceptions = orig.getExceptionTypes();
        setThrows(minfo, cp, exceptions);
    }

    private static void setThrows(org.hotswap.agent.javassist.bytecode.MethodInfo minfo, org.hotswap.agent.javassist.bytecode.ConstPool cp,
                                  Class[] exceptions) {
        ...
        org.hotswap.agent.javassist.bytecode.ExceptionsAttribute ea = new org.hotswap.agent.javassist.bytecode.ExceptionsAttribute(cp);
        ea.setExceptions(list);
        minfo.setExceptionsAttribute(ea);
    }

    private static int addLoadParameters(org.hotswap.agent.javassist.bytecode.Bytecode code, Class[] params,
                                         int offset) {
        int stacksize = 0;
        int n = params.length;
        for (int i = 0; i < n; ++i)
    ...
    private static int addLoad(org.hotswap.agent.javassist.bytecode.Bytecode code, int n, Class type) {
        if (type.isPrimitive()) {
            if (type == Long.TYPE) {
                code.addLload(n);
                return 2;
    ...
    private static int addReturn(org.hotswap.agent.javassist.bytecode.Bytecode code, Class type) {
        if (type.isPrimitive()) {
            if (type == Long.TYPE) {
                code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.LRETURN);
                return 2;
            } else if (type == Float.TYPE)
                code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.FRETURN);
            else if (type == Double.TYPE) {
                code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.DRETURN);
                return 2;
            } else if (type == Void.TYPE) {
                code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.RETURN);
                return 0;
            } else
                code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.IRETURN);
        } else
    ...
    private static void makeParameterList(org.hotswap.agent.javassist.bytecode.Bytecode code, Class[] params) {
        int regno = 1;
        int n = params.length;
        code.addIconst(n);
        code.addAnewarray("java/lang/Object");
        for (int i = 0; i < n; i++) {
            code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.DUP);
            code.addIconst(i);
            Class type = params[i];
            if (type.isPrimitive())
            ...
            code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.AASTORE);
        }
    }

    private static int makeWrapper(org.hotswap.agent.javassist.bytecode.Bytecode code, Class type, int regno) {
        int index = org.hotswap.agent.javassist.util.proxy.FactoryHelper.typeIndex(type);
        String wrapper = org.hotswap.agent.javassist.util.proxy.FactoryHelper.wrapperTypes[index];
        code.addNew(wrapper);
        code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.DUP);
        addLoad(code, regno, type);
        code.addInvokespecial(wrapper, "<init>",
                org.hotswap.agent.javassist.util.proxy.FactoryHelper.wrapperDesc[index]);
        return regno + org.hotswap.agent.javassist.util.proxy.FactoryHelper.dataSize[index];
    }

    private static void addUnwrapper(org.hotswap.agent.javassist.bytecode.Bytecode code, Class type) {
        if (type.isPrimitive()) {
            if (type == Void.TYPE)
                code.addOpcode(org.hotswap.agent.javassist.bytecode.Opcode.POP);
            else {
                int index = org.hotswap.agent.javassist.util.proxy.FactoryHelper.typeIndex(type);
                String wrapper = org.hotswap.agent.javassist.util.proxy.FactoryHelper.wrapperTypes[index];
                code.addCheckcast(wrapper);
                code.addInvokevirtual(wrapper,
                        org.hotswap.agent.javassist.util.proxy.FactoryHelper.unwarpMethods[index],
                        org.hotswap.agent.javassist.util.proxy.FactoryHelper.unwrapDesc[index]);
            }
        } else
            code.addCheckcast(type.getName());
    }

    private static org.hotswap.agent.javassist.bytecode.MethodInfo makeWriteReplace(org.hotswap.agent.javassist.bytecode.ConstPool cp) {
        org.hotswap.agent.javassist.bytecode.MethodInfo minfo = new org.hotswap.agent.javassist.bytecode.MethodInfo(cp, "writeReplace", "()Ljava/lang/Object;");
        String[] list = new String[1];
        list[0] = "java.io.ObjectStreamException";
        org.hotswap.agent.javassist.bytecode.ExceptionsAttribute ea = new org.hotswap.agent.javassist.bytecode.ExceptionsAttribute(cp);
        ea.setExceptions(list);
        minfo.setExceptionsAttribute(ea);
        org.hotswap.agent.javassist.bytecode.Bytecode code = new org.hotswap.agent.javassist.bytecode.Bytecode(cp, 0, 1);
        code.addAload(0);
